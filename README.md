...
4. **¿Qué verás en pantalla?** Las tarjetas de resumen superiores se recalcularán mostrando el **Total de Proyectos Encontrados** y el **Total de Estudiantes Involucrados**. La tabla te mostrará el detalle exacto de los registros con sus fechas para exportación a **Excel (`.XLS`)** o **PDF/HTML**.
