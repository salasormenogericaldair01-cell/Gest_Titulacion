...
IF EXIST "Gestion_Titulacion\dist\Gestion_Titulacion_Ejecutable.jar" (
    echo [OK] Ejecutando JAR unificado standalone...
    start "" javaw -jar "Gestion_Titulacion\dist\Gestion_Titulacion_Ejecutable.jar"
    goto :fin
)

IF EXIST "Gestion_Titulacion\dist\Gestion_Titulacion.jar" (
    echo [OK] Ejecutando JAR principal desde carpeta dist...
    start "" javaw -jar "Gestion_Titulacion\dist\Gestion_Titulacion.jar"
    goto :fin
)
